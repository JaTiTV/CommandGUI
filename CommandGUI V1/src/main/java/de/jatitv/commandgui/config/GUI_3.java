...
public class GUI_3 {
    ...
    public static void configCreate(String version) throws InterruptedException {
        ...
        if (!yamlConfiguration_GUI3.contains("Do_not_remove_or_change.Created"))
            yamlConfiguration_GUI3.set("Do_not_remove_or_change.Created", "This file was created with version " + version);
        yamlConfiguration_GUI3.set("Do_not_remove_or_change.Version", version);
        ...
        if (DefaultValue_GUI_3.GUILines == 1 || DefaultValue_GUI_3.GUILines > 1) {
            ...
            if (!Main.minecraft1_8 || !Main.minecraft1_9 || !Main.minecraft1_10 || !Main.minecraft1_11 || !Main.minecraft1_12) {
                if (yamlConfiguration_GUI3.contains("Functions.Line_1.Slot_1.Playerhead")) {
                    DefaultValue_GUI_3.L1_S1_Playerhead = yamlConfiguration_GUI3.getBoolean("Functions.Line_1.Slot_1.Playerhead");
                } else {
                    yamlConfiguration_GUI3.set("Functions.Line_1.Slot_1.Playerhead", DefaultValue_GUI_3.L1_S1_Playerhead);
                    if (GUI3YML.isFile())
                        Bukkit.getConsoleSender().sendMessage(DefaultValue.PrefixHC + "§4Setting §6Line_1 Slot_1 Playerhead §4was added to §9GUI_3.yml§4!");
                }
            }
