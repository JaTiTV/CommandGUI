...
public class DefultValue {
    ...
    public static Sound Sound_Click = Sound.ENTITY_PLAYER_LEVELUP;
    public static String Sound_Click_input = "ENTITY_PLAYER_LEVELUP";

    public static Boolean Sound_NoMoney_Enable = true;
    public static Sound Sound_NoMoney = Sound.BLOCK_NOTE_BLOCK_HARP;
    public static String Sound_NoMoney_input = "BLOCK_NOTE_BLOCK_HARP";
    ...
    public static void Help(CommandSender sender) {
        if (sender.hasPermission("commandgui.command")
                ...
                || sender.isOp()) {
            sender.sendMessage(PrefixHC + " §8----- §6Command§9GUI §chelp §8-----");
