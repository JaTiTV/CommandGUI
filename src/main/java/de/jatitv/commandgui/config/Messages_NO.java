...
public class Messages_NO {
    ...
    public static void messagesCreate() {
        ...
        if (!yamlConfiguration_NOmsg.contains("Do_not_remove_or_change.Created")) yamlConfiguration_NOmsg.set("Do_not_remove_or_change.Created", "This file was created with version " + Main.getPlugin().getDescription().getVersion());
